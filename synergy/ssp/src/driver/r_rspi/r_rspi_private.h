 ...
 * Macro definitions
 **********************************************************************************************************************/
#define RSPI_BYTE_DATA 0x01U
#define RSPI_WORD_DATA 0x02U
#define RSPI_LONG_DATA 0x04U
...
#define RSPI_SPSR_OVRF          (0x01U) /* 0: No overrun error.          1: An overrun error occurred. */
#define RSPI_SPSR_IDLNF         (0x02U) /* 0: RSPI is in the idle state. 1: RSPI is in the transfer state. */
#define RSPI_SPSR_MODF          (0x04U) /* 0: No mode fault error        1: A mode fault error occurred */
#define RSPI_SPSR_PERF          (0x08U) /* 0: No parity error.           1: A parity error occurred. */
#define RSPI_SPSR_UDRF          (0x10U) /* 0: mode fault error (if MODF =1) 1: Underrun error (if MODF = 1)*/
#define RSPI_SPSR_SPRF          (0x80U) /* 0: No valid data in SPDR 1: Valid data in SPDR */
#define RSPI_SPSR_MASK          (0xA0) /* Protect reserved bits. */
#define RSPI_SPSR_MASK_CLEAR    (0xBD) /* Mask used for clearing error flags. */
...
#define RSPI_SPCMD_SPB_8BIT  (0x4U)    /* value for 8 bits data length */
#define RSPI_SPCMD_SPB_16BIT (0xFU)    /* value for 8 bits data length */
#define RSPI_SPCMD_SPB_32BIT (0x3U)    /* value for 8 bits data length */

#define RSPI_SPBR_MAX_VAL    (255U)
