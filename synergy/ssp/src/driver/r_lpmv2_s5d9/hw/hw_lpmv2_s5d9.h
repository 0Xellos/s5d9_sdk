...
/**********************************************************************************************************************
 * File Name    : hw_lpmv2_s5d9.h
 * Description  : LPMV2 S5D9 specific macros.
 **********************************************************************************************************************/

#ifndef HW_LPMV2_S5D9_H_
#define HW_LPMV2_S5D9_H_
...
#define HW_LPMV2_DEEP_STANDBY_CANCEL_SOURCE_MASK    0x071F7FFFU
#define HW_LPMV2_DEEP_STANDBY_CANCEL_EDGE_MASK      0x00137FFFU
...
{
    /*
     * From the S5D9 user's manual: 11.2.23 System Control OCD Control Register (SYOCDCR)
