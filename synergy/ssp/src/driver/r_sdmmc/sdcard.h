...
#define SDMMC_SD_DEFAULT_CLOCK_RATE      (25000000U)                   /* 25 MHz */
#define SDMMC_SD_HIGH_SPEED_CLOCK_RATE   (50000000U)                   /* 50 MHz */
#define SDMMC_SDIO_HIGH_SPEED_CLOCK_RATE (50000000U)                   /* 50 MHz */
