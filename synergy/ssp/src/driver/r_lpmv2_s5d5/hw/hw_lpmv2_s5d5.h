...
/**********************************************************************************************************************
 * File Name    : hw_lpmv2_s5d5.h
 * Description  : LPMV2 S5D5 specific macros.
 **********************************************************************************************************************/

#ifndef HW_LPMV2_S5D5_H_
#define HW_LPMV2_S5D5_H_
...
#define HW_LPMV2_STANDBY_WAKE_SOURCE_MASK           0xFB4FFFFFU

#define HW_LPMV2_DEEP_STANDBY_CANCEL_SOURCE_MASK    0x051F3FFFU
#define HW_LPMV2_DEEP_STANDBY_CANCEL_EDGE_MASK      0x00133FFFU
...
{
    /*
     * From the S5D5 user's manual: 11.2.23 System Control OCD Control Register (SYOCDCR)
