...
/*LDRA_INSPECTED 27 D This structure cannot be static because it is externed in hw_lpmv2_s5d3.c when error logging is
 ...
 *
 * @retval SSP_SUCCESS              Low power mode successfuly applied
