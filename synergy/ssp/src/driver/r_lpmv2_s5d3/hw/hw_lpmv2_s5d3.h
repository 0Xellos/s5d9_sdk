...
/**********************************************************************************************************************
 * File Name    : hw_lpmv2_s5d3.h
 * Description  : LPMV2 S5D3 specific macros.
 **********************************************************************************************************************/

#ifndef HW_LPMV2_S5D3_H_
#define HW_LPMV2_S5D3_H_
...
{
    /*
     * From the S5D3 user's manual: 11.2.23 System Control OCD Control Register (SYOCDCR)
