...
ssp_err_t R_RIIC_SlaveOpen         (i2c_ctrl_t             * const p_ctrl,
		                           i2c_cfg_t      const   * const p_cfg);
ssp_err_t R_RIIC_SlaveClose        (i2c_ctrl_t             * const p_ctrl);
ssp_err_t R_RIIC_MasterWriteSlaveRead (i2c_ctrl_t             * const p_ctrl,
                                     uint8_t                * const p_dest,
                                     uint32_t       const           bytes);
ssp_err_t R_RIIC_MasterReadSlaveWrite (i2c_ctrl_t             * const p_ctrl,
                                     uint8_t                * const p_src,
                                     uint32_t       const           bytes);
