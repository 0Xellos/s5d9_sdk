...
/**********************************************************************************************************************
 * File Name    : hw_lpmv2_s3a6.h
 * Description  : LPMV2 S3A6 specific macros.
 **********************************************************************************************************************/

#ifndef HW_LPMV2_S3A6_H_
#define HW_LPMV2_S3A6_H_
...
/* SNZREQCR register mask HW Manual 10.2.10 */
#define HW_LPMV2_SNOOZE_REQUEST_MASK        0x7382DFFFU
/* SNZEDCR register mask HW Manual 10.2.9 */
#define HW_LPMV2_SNOOZE_END_MASK            0x0000009FU
/* WUPEN register mask HW Manual 13.2.9 */
#define HW_LPMV2_STANDBY_WAKE_SOURCE_MASK   0xFB9FDFFFU
...
/*******************************************************************************************************************//**
 * @brief Clear the IOKEEP bit in DPSBYCR register
 **********************************************************************************************************************/
