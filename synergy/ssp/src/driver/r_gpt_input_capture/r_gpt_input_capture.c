                                                   ...
                                                   ssp_feature_t       const * const p_feature)
{
    ...
    **/
    ...
    /** Configuring the timer input control register for input noise filter */
    HW_GPT_InputSignalNoiseFilterSet(p_gpt_reg, p_extend->enable_filter, p_extend->signal);
    HW_GPT_NoiseFilterSamplingClockSelect(p_gpt_reg, p_extend->signal_filter, p_extend->signal);
