...
#ifndef R_IWDT_PRIVATE_API_H
#define R_IWDT_PRIVATE_API_H
...
ssp_err_t R_IWDT_StatusClear (wdt_ctrl_t * const p_ctrl, const wdt_status_t status);
...
ssp_err_t R_IWDT_TimeoutGet (wdt_ctrl_t * const p_ctrl, wdt_timeout_values_t * const p_timeout);
