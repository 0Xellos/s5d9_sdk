...
#define MINIMUM_SUPPORTED_FCLK_FREQ 1000000U            /// Minimum FCLK for Flash Operations in Hz
 ...
 * @retval SSP_ERR_FCLK              FCLK must be a minimum of 1 MHz for Flash operations.
 ...
 * @retval SSP_ERR_FCLK              FCLK must be >= 1 MHz.
...
static ssp_err_t flash_setup (flash_lp_instance_ctrl_t * const p_ctrl)
{
    ...
    if (SSP_SUCCESS == err)
    {
        /** FCLK must be a minimum of 1 MHz for Flash operations. If not return error. */
