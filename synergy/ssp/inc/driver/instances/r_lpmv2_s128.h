...
/**********************************************************************************************************************
 * File Name    : r_lpmv2_s128.h
 * Description  : LPMV2 HAL API header file
 **********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @ingroup HAL_Library
 * @defgroup LPMV2_S128 LPMV2 S128
...
#ifndef R_LPMV2_S128_H
#define R_LPMV2_S128_H
...
typedef enum e_lpmv2_snooze_cancel
{
    ...
    LPMV2_SNOOZE_CANCEL_SOURCE_SCI0_AM                  = (122), // SCI0 address match event
    LPMV2_SNOOZE_CANCEL_SOURCE_SCI0_RXI_OR_ERI          = (123), // SCI0 receive error
    LPMV2_SNOOZE_CANCEL_SOURCE_DTC_COMPLETE             = (9),   // DTC transfer completion
    LPMV2_SNOOZE_CANCEL_SOURCE_DOC_DOPCI                = (54),  // Data operation circuit interrupt
...
#endif /* R_LPMV2_S128_H */

/*******************************************************************************************************************//**
 * @} (end defgroup LPMV2_S128)
 **********************************************************************************************************************/
