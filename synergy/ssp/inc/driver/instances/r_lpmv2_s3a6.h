...
/**********************************************************************************************************************
 * File Name    : r_lpmv2_s3a6.h
 * Description  : LPMV2 HAL API header file
 **********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @ingroup HAL_Library
 * @defgroup LPMV2_S3A6 LPMV2 S3A6
...
#ifndef R_LPMV2_S3A6_H
#define R_LPMV2_S3A6_H
...
typedef enum e_lpmv2_snooze_cancel
{
    ...
    LPMV2_SNOOZE_CANCEL_SOURCE_SCI0_AM                  = (156), // SCI0 address match event
    LPMV2_SNOOZE_CANCEL_SOURCE_SCI0_RXI_OR_ERI          = (157), // SCI0 receive error
    LPMV2_SNOOZE_CANCEL_SOURCE_DTC_COMPLETE             = (21),  // DTC transfer completion
    LPMV2_SNOOZE_CANCEL_SOURCE_DOC_DOPCI                = (70),  // Data operation circuit interrupt
...
#endif /* R_LPMV2_S3A6_H */

/*******************************************************************************************************************//**
 * @} (end defgroup LPMV2_S3A6)
 **********************************************************************************************************************/
