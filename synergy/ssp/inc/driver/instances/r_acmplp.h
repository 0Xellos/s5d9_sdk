 ...
 **********************************************************************************************************************/
/**********************************************************************************************************************
* File Name    : r_acmplp.h
* Description  : Low power analog comparator instance header file.
***********************************************************************************************************************/
...
/*******************************************************************************************************************//**
 * @ingroup HAL_Library
 * @defgroup ACMPLP Low Power Analog Comparator
 * @brief Driver for the Low Power Analog Comparator.
 *
 * @section ACMPLP_SUMMARY Summary
 * Extends @ref COMPARATOR_API.
 *
 * This module implements the @ref COMPARATOR_API using the low power analog comparator.
 * @{
 **********************************************************************************************************************/
...
Macro definitions
***********************************************************************************************************************/
#define ACMPLP_CODE_VERSION_MAJOR   (2U)
#define ACMPLP_CODE_VERSION_MINOR   (0U)
...
typedef struct st_acmplp_instance_ctrl
{
    ...
    R_ACMPLP_Type * p_reg;   // Pointer to register base address
    ...
    comparator_polarity_invert_t invert; // whether or not output is inverted
