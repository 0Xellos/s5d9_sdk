...
/**********************************************************************************************************************
 * File Name    : r_lpmv2_s124.h
 * Description  : LPMV2 HAL API header file
 **********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @ingroup HAL_Library
 * @defgroup LPMV2_S124 LPMV2 S124
...
#ifndef R_LPMV2_S124_H
#define R_LPMV2_S124_H
...
typedef enum e_lpmv2_snooze_request
{
    ...
    LPMV2_SNOOZE_REQUEST_ACMPLP             = 0x00800000U,  ///< Enable Low-speed analog comparator snooze request
                                                            ///< (S124, S128, S1JA, S3A1, S3A3, S3A6, S3A7).
...
typedef enum e_lpmv2_snooze_cancel
{
    ...
    LPMV2_SNOOZE_CANCEL_SOURCE_SCI0_AM                  = (113), // SCI0 address match event
    LPMV2_SNOOZE_CANCEL_SOURCE_SCI0_RXI_OR_ERI          = (114), // SCI0 receive error
    LPMV2_SNOOZE_CANCEL_SOURCE_DTC_COMPLETE             = (9),   // DTC transfer completion
    LPMV2_SNOOZE_CANCEL_SOURCE_DOC_DOPCI                = (51),  // Data operation circuit interrupt
...
#endif /* R_LPMV2_S124_H */

/*******************************************************************************************************************//**
 * @} (end defgroup LPMV2_S124)
 **********************************************************************************************************************/
