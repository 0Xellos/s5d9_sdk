...
/**********************************************************************************************************************
 * File Name    : r_lpmv2_s3a1.h
 * Description  : LPMV2 HAL API header file
 **********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @ingroup HAL_Library
 * @defgroup LPMV2_S3A1 LPMV2 S3A1
...
#ifndef R_LPMV2_S3A1_H
#define R_LPMV2_S3A1_H
...
{
    LPMV2_SNOOZE_CANCEL_SOURCE_ADC0_WCMPM               = (45),  // ADC Channel 0 window compare match
    LPMV2_SNOOZE_CANCEL_SOURCE_ADC0_WCMPUM              = (46),  // ADC Channel 0 window compare mismatch
    LPMV2_SNOOZE_CANCEL_SOURCE_SCI0_AM                  = (176), // SCI0 address match event
    LPMV2_SNOOZE_CANCEL_SOURCE_SCI0_RXI_OR_ERI          = (177), // SCI0 receive error
    LPMV2_SNOOZE_CANCEL_SOURCE_DTC_COMPLETE             = (21),  // DTC transfer completion
    LPMV2_SNOOZE_CANCEL_SOURCE_DOC_DOPCI                = (74),  // Data operation circuit interrupt
...
#endif /* R_LPMV2_S3A1_H */

/*******************************************************************************************************************//**
 * @} (end defgroup LPMV2_S3A1)
 **********************************************************************************************************************/
