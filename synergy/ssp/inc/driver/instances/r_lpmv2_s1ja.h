...
/**********************************************************************************************************************
 * File Name    : r_lpmv2_s1ja.h
 * Description  : LPMV2 HAL API header file
 **********************************************************************************************************************/

/*******************************************************************************************************************//**
 * @ingroup HAL_Library
 * @defgroup LPMV2_S1JA LPMV2 S1JA
...
#ifndef R_LPMV2_S1JA_H
#define R_LPMV2_S1JA_H
...
{
    LPMV2_SNOOZE_REQUEST_RXD0_FALLING       = 0x00000000U,  // Enable RXD0/DALI falling edge snooze request
...
{
    LPMV2_SNOOZE_CANCEL_SOURCE_ADC0_WCMPM               = (32),  // ADC Channel 0 window compare match
    LPMV2_SNOOZE_CANCEL_SOURCE_ADC0_WCMPUM              = (33),  // ADC Channel 0 window compare mismatch
    LPMV2_SNOOZE_CANCEL_SOURCE_SCI0_AM                  = (117), // SCI0 address match event
    LPMV2_SNOOZE_CANCEL_SOURCE_SCI0_RXI_OR_ERI          = (118), // SCI0 receive error
    LPMV2_SNOOZE_CANCEL_SOURCE_DTC_COMPLETE             = (9),   // DTC transfer completion
    LPMV2_SNOOZE_CANCEL_SOURCE_DOC_DOPCI                = (52),  // Data operation circuit interrupt
...
#endif /* R_LPMV2_S1JA_H */

/*******************************************************************************************************************//**
 * @} (end defgroup LPMV2_S1JA)
 **********************************************************************************************************************/
