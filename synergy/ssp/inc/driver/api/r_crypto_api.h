...
#define CRYPTO_API_VERSION_MINOR (0U)
...
typedef enum e_crypto_key_size
{
    ...
    CRYPTO_KEY_SIZE_ECC_224,
    CRYPTO_KEY_SIZE_ECC_384,
    /* Add any new entries here */
    CRYPTO_KEY_SIZE_MAX
}crypto_key_size_t;
...
typedef enum e_crypto_module_status
{
    CRYPTO_SCE_COMMON_MODULE_CLOSED = 0,            ///< The module is closed.
    CRYPTO_SCE_COMMON_MODULE_OPENED = 1,            ///< The module is opened.
