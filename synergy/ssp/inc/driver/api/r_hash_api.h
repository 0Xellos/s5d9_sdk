...
#define HASH_API_VERSION_MINOR (0U)

#define HASH_MESSAGE_BLOCK_SIZE_WORDS (16U)
...
typedef struct st_hash_api
{
     ...
     *  @param[in] p_ctrl Pointer to the hash_ctrl_t control structure
     */
...
extern const hash_api_t g_md5_hash_on_sce;
