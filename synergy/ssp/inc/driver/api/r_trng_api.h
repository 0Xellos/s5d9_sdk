...
#define TRNG_API_VERSION_MINOR (0U)

#define TRNG_REGISTER_SIZE_WORDS (4U)
#define TRNG_REGISTER_SIZE_BYTES ((TRNG_REGISTER_SIZE_WORDS) * 4U)
...
typedef struct st_trng_api
{
     ...
     *  @param[in]   nwords number of random words to generate
     */
